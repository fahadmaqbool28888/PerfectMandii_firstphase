package com.customer.perfectcustomer.Activity;
...
import com.customer.perfectcustomer.Model.SubCategories.SubCategoriesRelevant;
      ...
      //  colorblock_dialog=alertDialog.findViewById(R.id.colorblock_dialog);
        ...
        picker1.setOnValueChangedListener(new NumberPicker.OnValueChangeListener() {
            ...
            public void onValueChange(NumberPicker picker, int oldVal, int newVal) {
                ...
                editFlag.setText("Your Quantity: "+ picker.getValue());
                calculate(0);
...
*  "id": "1",
    ...
    private  class AsyncTaskUploadClass extends AsyncTask<Void,Void,String>
    {
        ...
        protected String doInBackground(Void... params)
        {
            ...
            System.out.println("proid"+" "+proid+" "+"userid"+" "+userid+" "+"id"+" "+id+" "+"session"+" "+session+""+"count"+" "+ count +" "+"Product Price"+" "+ProductPrice+""+"gtotal"+" "+ gtotal +" "+"newOrder"+" "+newOrder);
