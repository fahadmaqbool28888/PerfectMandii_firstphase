...
import com.customer.perfectcustomer.Adapter.OrderConsigneeAdapter;
import com.customer.perfectcustomer.Model.ModelTemp;
...
{    int oc,tdeliv;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        Toolbar toolbar = findViewById(R.id.toolbar_OrderDetailActivity);
