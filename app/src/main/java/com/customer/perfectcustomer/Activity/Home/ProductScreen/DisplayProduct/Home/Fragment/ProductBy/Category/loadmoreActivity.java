package com.customer.perfectcustomer.Activity.Home.ProductScreen.DisplayProduct.Home.Fragment.ProductBy.Category;
...
import com.customer.perfectcustomer.Adapter.SubCatogories.subItemAdapter_More;
...
{
    JSONArray data;
    String userid,session,jsonArray,categoryname,l1,vi;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        if (vi!=null)
        {
            urls="https://sellerportal.perfectmandi.com/load_moreProduct.php?id="+l1+"&cat="+categoryname+"&vi="+vi;
        }
        else
        {
            urls="https://sellerportal.perfectmandi.com/load_moreProduct.php?id="+l1+"&cat="+categoryname;
        }
    ...
    private class AsyncFetch extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            try
            {
                ...
                System.out.println("https://sellerportal.perfectmandi.com/load_moreProduct.php?id="+l1+"&cat="+categoryname+"&vi="+vi);
                url = new URL(urls);
