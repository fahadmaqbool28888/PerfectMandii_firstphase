package com.customer.perfectcustomer.Activity.Home.ProductScreen.DisplayProduct.Home.Fragment.ProductBy;
...
import com.customer.perfectcustomer.Activity.Home.ProductScreen.DisplayProduct.Home.Fragment.ProductBy.Category.by.Product;
import com.customer.perfectcustomer.Activity.Home.ProductScreen.DisplayProduct.Home.Fragment.ProductBy.Category.by.vendor;
...
public class DashboardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
       ...
       /* session = intent.getStringExtra("session");*/
        ...
        String headingname=intent.getStringExtra("category");

        String str=categoryname.replaceAll("[^a-zA-Z]"," ");
        part1.setText(headingname);
