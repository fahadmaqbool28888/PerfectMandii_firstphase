package com.customer.perfectcustomer.Activity.Home.ProductScreen.DisplayProduct.Home.Fragment;
...
import com.customer.perfectcustomer.Adapter.ContentAdapter;
    ...
    private class AsyncFetch extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            try
            {
                ...
                url = new URL("https://sellerportal.perfectmandi.com/stagingindex.php");
            // live_url //  url = new URL("https://sellerportal.perfectmandi.com/product_index.php");
