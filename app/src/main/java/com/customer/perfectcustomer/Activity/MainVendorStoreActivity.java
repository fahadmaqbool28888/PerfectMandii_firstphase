...
public class MainVendorStoreActivity extends AppCompatActivity {
    ...
    {
        subcategoriesadapter= new popULATE_Categories(MainVendorStoreActivity.this, datas, flag) {
            @Override
    ...
    private class AsyncFetch extends AsyncTask<String, String, String>
    {
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                String urls="https://sellerportal.perfectmandi.com/store_category.php?id="+pro+"&psc="+Prodcut_Sub_Category;
