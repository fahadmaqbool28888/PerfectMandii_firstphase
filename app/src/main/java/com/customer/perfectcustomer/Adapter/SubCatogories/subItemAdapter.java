...
public class subItemAdapter extends RecyclerView.Adapter<subItemAdapter.MyHolder>
{
    int quan,gp;
    int mquan;
    Double fr;
    ...
    public subItemAdapter(Context context, JSONArray data)
    {
   ...
   public subItemAdapter(Context context, JSONArray data,String userid,String session,String categoryname)
    {
        this.context=context;
        this.data=data;
        layoutInflater=LayoutInflater.from(context);
    ...
    List<ProductSub> fetechjsonArray(JSONArray jsonArray) throws JSONException
    {
        ...
        for(int k=0;k<jsonArray.length();k++)
        {
            ...
            int quan=Integer.parseInt(productSub.product_quan);
            int mqo=Integer.parseInt(productSub.product_quan);
