...
import com.customer.perfectcustomer.Activity.Home.ProductScreen.DisplayProduct.CategoryByVendorActivity;
...
public class AdapterVendorPrime extends RecyclerView.Adapter<RecyclerView.ViewHolder>
{
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        System.out.println(current.image_url);
...
//        myHolder.ratingBar.setRating(4);
        ...
        Glide.with(context).load("https://sellerportal.perfectmandi.com/"+current.image_url).into(myHolder.ivFish);
        myHolder.mainvps.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("storename",current.name);
                intent.putExtra("vi",setca);
                intent.putExtra("category",current.st_category);
                intent.putExtra("url",current.image_url);
    ...
    class MyHolder extends RecyclerView.ViewHolder{
       ...
       TextView getstorename,getstorespeciality;
        ...
        public MyHolder(View itemView) {
            ...
            ivFish= itemView.findViewById(R.id.ivFish_vendorprime);
