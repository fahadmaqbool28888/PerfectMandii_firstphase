...
public void onBindViewHolder(MyHolder holder, int position) {
    ...
    try {
        ...
        System.out.println(holder.product_name_);
        System.out.println(holder.product_img);
        ...
        {
            String urls="https://sellerportal.perfectmandi.com/"+productSub.product_image_path;
            Picasso.get().load(urls).into(holder.product_img);
