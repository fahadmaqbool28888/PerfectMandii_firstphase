...
public void onBindViewHolder(RecyclerView.ViewHolder holder, int position)
{
        ...
        myHolder.ppname_vendorend.setText(current.name);
        myHolder.pprice_vendor.setText("PKR: "+current.price);
...
class MyHolder extends RecyclerView.ViewHolder{
    ...
    TextView ppname_vendorend,pprice_vendor,textprice;
   ImageView ivFish;
    ...
    public MyHolder(View itemView) {
        ...
        ppname_vendorend=itemView.findViewById(R.id.ppname_vendorend);
        pprice_vendor=itemView.findViewById(R.id.pprice_vendor);
