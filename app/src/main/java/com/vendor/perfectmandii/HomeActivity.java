...
import com.vendor.perfectmandii.Adapter.SubjectAdapter;
import com.vendor.perfectmandii.Model.CategoryModel;
import com.vendor.perfectmandii.Model.Chapter;
import com.vendor.perfectmandii.Model.ProductModel.ProductModel;
import com.vendor.perfectmandii.Model.Subject;
...
*/
    ...
    private ArrayList<Subject> prepareData()
    {
        ...
        System.out.println(String.valueOf(newList.size()));
        System.out.println(imagecategory.get(j).toString());
        ...
        System.out.println("Total Value will be "+String.valueOf(count));
