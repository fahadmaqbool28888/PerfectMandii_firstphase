...
import com.vendor.perfectmandii.Reciever.MyReciver;
...
public class EditProfileActivity extends AppCompatActivity {
  String ConvertImage;
    ...
    private void getlocation()
    {
        ...
        IntentFilter filter = new IntentFilter("com.practicesession.myapplication");
        registerReceiver(m, filter);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            startForegroundService(new Intent(EditProfileActivity.this, GPSService.class));
        } else {

            startService(new Intent(EditProfileActivity.this, GPSService.class));
            Toast.makeText(EditProfileActivity.this, "Tracking Started..", Toast.LENGTH_SHORT).show();
        }
    ...
    public BroadcastReceiver broadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            double latitude = Double.valueOf(intent.getStringExtra("lat"));
            double longitude = Double.valueOf(intent.getStringExtra("lng"));

            latv=String.valueOf(latitude);
            lngv=String.valueOf(longitude);
            ...
            try {
                ...
                getbillingaddress.setText(cityName);

                if (cityName.contains("Punjab"))
                {
                    provinceText.setText("Punjab");
                    if (cityName.contains("Rawalpindi"))
                    {
                        getCityText.setText("Rawalpindi");
                    }
                    if (cityName.contains("Lahore"))
                    {
                        getCityText.setText("Lahore");
                    }

                   // provinceText.setText("Punjab");
                }
                else if (cityName.contains("Sindh"))
                {
                    provinceText.setText("Sindh");
                }
                /*Quetta, Balochistan, Pakistan*/
                else if (cityName.contains("Balochistan"))
                {
                    provinceText.setText("Balochistan");
                }
                /*Grand Trunk Rd, Sikander Town Gulbahar, Peshawar, Khyber Pakhtunkhwa, Pakistan*/
                else if (cityName.contains("Khyber Pakhtunkhwa"))
                {
                    provinceText.setText("Khyber Pakhtunkhwa");
                }
                else if (cityName.contains("Gilgit-Baltistan"))
                {
                    provinceText.setText("Gilgit-Baltistan");
                    /*Karakoram Hwy, near Bus Wagon Station, Aliabad, Ali Abad, Hunza, Gilgit-Baltistan*/
                }
                else if (cityName.contains("Azad Jammu and Kashmir"))
                {
                    provinceText.setText("Azad Jammu and Kashmir");
                    /*Upper Chattar، Muzaffarabad, Azad Jammu and Kashmir*/
                }
                ...
                if (cityName!=null)
                {
                    stopService(new Intent(EditProfileActivity.this, GPSService.class));
                }
            }
        ...
        class AsyncTaskUploadClass extends AsyncTask<Void,Void,String> {
            ...
            protected String doInBackground(Void... params) {
              ...
              ImageProcessClass imageProcessClass = new ImageProcessClass();
                ...
                {
                    HashMapParams.put(ImagePath, avatar_image);
                    HashMapParams.put(full_name, fullname); //fullname
                    HashMapParams.put(Mobilenumber, mobilenumber); //mobile Number
                    HashMapParams.put(Cnic, cnic); //Cnic
                    HashMapParams.put(City, selected_city); //City
