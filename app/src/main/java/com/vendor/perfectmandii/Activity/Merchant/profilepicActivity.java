package com.vendor.perfectmandii.Activity.Merchant;
...
public class profilepicActivity extends AppCompatActivity
{
    ...
    ImageView uploadsignal,back_Q,profile_pic_;
    ...
    void init_Widget()
    {
        ...
        profile_pic_=findViewById(R.id.profile_pic_);
    ...
    protected void onActivityResult(int RC, int RQC, Intent I) {
        ...
        if (RC == 1 && RQC == RESULT_OK && I != null && I.getData() != null) {
            ...
            try {
                Bitmap cbitmap=MediaStore.Images.Media.getBitmap(getContentResolver(),uri);
                Bitmap redbitmap=getResizedBitmap(cbitmap,15);
                bitmap=redbitmap;
              ...
              //  bitmap = MediaStore.Images.Media.getBitmap(getContentResolver(), uri);
                ...
                {
                    profile_pic_.setImageBitmap(bitmap);
    ...
    public void ImageUploadToServerFunction(){
        ...
        class AsyncTaskUploadClass extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                ...
                progressDialog = ProgressDialog.show(profilepicActivity.this,"Image is Uploading","Please Wait",false,false);
            }
            ...
            protected void onPostExecute(String string1) {
                ...
                Toast.makeText(profilepicActivity.this,string1,Toast.LENGTH_LONG).show();

                // Setting image as transparent after done uploading.
                imageView.setImageResource(android.R.color.transparent);

                Intent intent=new Intent(profilepicActivity.this, UserOrderActivity.class);
