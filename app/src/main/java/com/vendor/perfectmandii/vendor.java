...
import com.vendor.perfectmandii.Adapter.AdapterVendorPrime;
...
public class vendor extends Fragment
{
    ...
    public vendor(String session,String id,String userid,String categoryname)
    {
    ...
    private class AsyncFetch extends AsyncTask<String, String, String>
    {
        ...
        protected String doInBackground(String... params)
        {
            try {
                ...
                url = new URL("https://staginigserver.perfectmandi.com/vendorprime.php?id="+id);
