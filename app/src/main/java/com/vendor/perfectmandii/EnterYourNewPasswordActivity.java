...
public class EnterYourNewPasswordActivity extends AppCompatActivity {
        ...
        btnnext.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                else
                {
                    ...
                    {
                        Toast.makeText(EnterYourNewPasswordActivity.this,"Pin is correct",Toast.LENGTH_LONG).show();
    ...
    private class AsyncFetch extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            try
            {
                String links="https://sellerportal.perfectmandi.com/update_pass_vendor.php?id="+number+"&value="+code+"&pass="+icons_pin;
